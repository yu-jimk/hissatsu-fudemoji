...
{
    public class Judge_Hiki : MonoBehaviour
    {
        ...
        string judgingHiki(){
                ...
                bool yon1 = 100.0 < start.x && start.x < 200.0;
                bool yon2 = 37.0 < start.y && start.y < 179.0;
                bool yon3 = 100.0 < end.x && end.x < 200.0;
                bool yon4 = -119.0 < end.y && end.y < 15.0;
                bool yon5 = sumDistance < 450.0;

                sumDistance = 0.0;

                if (yon1 & yon2 & yon3 & yon4 & yon5) //条件と比較
                {
