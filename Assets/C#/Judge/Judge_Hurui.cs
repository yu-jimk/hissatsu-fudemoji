...
{
    public class Judge_Hurui : MonoBehaviour
    {
        ...
        string judgingHurui(){
                ...
                bool shita1 = -11.0 < start.x && start.x < 181.0;
                bool shita2 = 91.0 < start.y && start.y < 271.0;
                bool shita3 = -209.0 < end.x && end.x < -19.0;
                bool shita4 = 85.0 < end.y && end.y < 191.0;
                bool shita5 = sumDistance < 520.0;
