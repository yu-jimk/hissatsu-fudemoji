...
{
    public class Judge_I : MonoBehaviour
    {
        ...
        string judgingI(){
                ...
                bool don1 = -55.0 < start.x && start.x < 55.0;
                bool don2 = -10.0 < start.y && start.y < 90.0;
                bool don3 = -60.0 < end.x && end.x < 55.0;
                bool don4 = -15.0 < end.y && end.y < 90.0;
                bool don5 = sumDistance < 140.0;


                sumDistance = 0.0;

                if (don1 & don2 & don3 & don4 & don5) //条件と比較
                {
