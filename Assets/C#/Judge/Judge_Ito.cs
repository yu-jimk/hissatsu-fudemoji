...
{
    public class Judge_Ito : MonoBehaviour
    {
        ...
        string judgingIto(){
                ...
                bool kei1 = -3.0 < start.x && start.x < 185.0;
                bool kei2 = 165.0 < start.y && start.y < 271.0;
                bool kei3 = -203.0 < end.x && end.x < -3.0;
                bool kei4 = 60.0 < end.y && end.y < 200.0;
                bool kei5 = sumDistance < 350.0;


                sumDistance = 0.0;

                if (kei1 & kei2 & kei3 & kei4 & kei5) //条件と比較
                {
