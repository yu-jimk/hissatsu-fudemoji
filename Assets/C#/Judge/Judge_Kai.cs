...
{
    public class Judge_Kai : MonoBehaviour
    {
        ...
        string judgingKai()
        {
            ...
            bool gu1 = -250.0 < start.x && start.x < -7.0;
            bool gu2 = -140.0 < start.y && start.y < -50.0;
            bool gu3 = 9.0 < end.x && end.x < 250.0;
            bool gu4 = -140.0 < end.y && end.y < -50.0;
            bool gu5 = sumDistance < 450.0;

            sumDistance = 0.0;

            if (gu1 & gu2 & gu3 & gu4 & gu5) //条件と比較
            {
