...
{
    public class Judge_Kawari : MonoBehaviour
    {
        ...
        string judgingKawari(){
                ...
                bool batu1 = 11.0 < start.x && start.x < 191.0;
                bool batu2 = -40.0 < start.y && start.y < 111.0;
                bool batu3 = -89.0 < end.x && end.x < 101.0;
                bool batu4 = -149.0 < end.y && end.y < 20.0;
                bool batu5 = sumDistance < 440.0;


                sumDistance = 0.0;

                if (batu1 & batu2 & batu3 & batu4 & batu5) //条件と比較
                {
