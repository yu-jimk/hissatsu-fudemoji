...
{
    public class Judge_Kokoro : MonoBehaviour
    {
        ...
        string judgingKokoro(){
                ...
                bool hitu1 = -30.0 < start.x && start.x < 150.0;
                bool hitu2 = -3.0 < start.y && start.y < 170.0;
                bool hitu3 = -190.0 < end.x && end.x < 11.0;
                bool hitu4 = -210.0 < end.y && end.y < -9.0;
                bool hitu5 = sumDistance < 600.0;

                sumDistance = 0.0;

                if (hitu1 & hitu2 & hitu3 & hitu4 & hitu5) //条件と比較
                {
