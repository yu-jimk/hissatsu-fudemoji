...
{
    public class Judge_Kyu : MonoBehaviour
    {
        ...
        string judgingKyu(){
                ...
                bool maru1 = -175.0 < start.x && start.x < 45.0;
                bool maru2 = -125.0 < start.y && start.y < 71.0;
                bool maru3 = -149.0 < end.x && end.x < 45.0;
                bool maru4 = -190.0 < end.y && end.y < 71.0;
                bool maru5 = start.x < end.x;
                bool maru6 = start.y > end.y;
                bool maru7 = sumDistance < 280.0;



                sumDistance = 0.0;

                if (maru1 & maru2 & maru3 & maru4 & maru5 & maru6 & maru7) //条件と比較
                {
