...
{
    public class Judge_Maboroshi : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            string judgingMaboroshi()
            {
                ...
                bool you1 = -41.0 < start.x && start.x < 131.0;
                bool you2 = 51.0 < start.y && start.y < 241.0;
                bool you3 = -99.0 < end.x && end.x < 91.0;
                bool you4 = -161.0 < end.y && end.y < 51.0;
                bool you5 = sumDistance < 600.0;

                sumDistance = 0.0;

                if (you1 & you2 & you3 & you4 & you5) //条件と比較
                {
