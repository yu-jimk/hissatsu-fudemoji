...
{
    public class Judge_Mai : MonoBehaviour
    {
        ...
        string judgingMai(){
                ...
                bool ri1 = -199.0 < start.x && start.x < -59.0;
                bool ri2 = 51.0 < start.y && start.y < 211.0;
                bool ri3 = -101.0 < end.x && end.x < 30.0;
                bool ri4 = 51.0 < end.y && end.y < 211.0;
                bool ri5 = sumDistance < 300.0;

                sumDistance = 0.0;

                if (ri1 & ri2 & ri3 & ri4 & ri5) //条件と比較
                {
