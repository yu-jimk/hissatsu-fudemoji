...
{
    public class Judge_Man : MonoBehaviour
    {
        ...
        string judgingMan(){
                ...
                bool hou1 = -50.0 < start.x && start.x < 35.0;
                bool hou2 = 105.0 < start.y && start.y < 261.0;
                bool hou3 = -50.0 < end.x && end.x < 35.0;
                bool hou4 = 70.0 < end.y && end.y < 130.0;
                bool hou5 = sumDistance < 220.0;

                sumDistance = 0.0;

                if (hou1 & hou2 & hou3 & hou4 & hou5) //条件と比較
                {
