...
{
    public class Judge_Me : MonoBehaviour
    {
        ...
        string judgingMe(){
                ...
                bool ji1 = -105.0 < start.x && start.x < 30.0;
                bool ji2 = 110.0 < start.y && start.y < 257.0;
                bool ji3 = -131.0 < end.x && end.x < 10.0;
                bool ji4 = 29.0 < end.y && end.y < 170.0;
                bool ji5 = sumDistance < 280.0;

                sumDistance = 0.0;

                if (ji1 & ji2 & ji3 & ji4 & ji5) //条件と比較
                {
