...
{
    public class Judge_Mi : MonoBehaviour
    {
        ...
        string judgingMi(){
                ...
                bool shu1 = -100.0 < start.x && start.x < 0.0;
                bool shu2 = 100.0 < start.y && start.y < 255.0;
                bool shu3 = -173.0 < end.x && end.x < -29.0;
                bool shu4 = 10.0 < end.y && end.y < 100.0;
                bool shu5 = sumDistance < 240.0;

                bool sue1 = -249.0 < start.x && start.x < -100.0;
                bool sue2 = 55.0 < start.y && start.y < 161.0;
                bool sue3 = 100.0 < end.x && end.x < 249.0;
                bool sue4 = 55.0 < end.y && end.y < 143.0;
                bool sue5 = sumDistance < 500.0;



                sumDistance = 0.0;

                if (shu1 & shu2 & shu3 & shu4 & shu5) //条件と比較
                {
