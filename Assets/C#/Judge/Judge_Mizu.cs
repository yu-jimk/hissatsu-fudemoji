...
{
    public class Judge_Mizu : MonoBehaviour
    {
        ...
        string judgingMizu(){
                ...
                bool Kori1 = -169.0 < start.x && start.x < 0.0;
                bool Kori2 = 45.0 < start.y && start.y < 221.0;
                bool Kori3 = -169.0 < end.x && end.x < 0.0;
                bool Kori4 = 45.0 < end.y && end.y < 221.0;
                bool Kori5 = sumDistance < 320.0;


                sumDistance = 0.0;

                if (Kori1 & Kori2 & Kori3 & Kori4 & Kori5) //条件と比較
                {
