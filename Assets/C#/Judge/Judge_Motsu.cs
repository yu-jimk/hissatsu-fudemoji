...
{
    public class Judge_Motsu : MonoBehaviour
    {
        ...
        string judgingMotsu(){
                ...
                bool toku1 = -209.0 < start.x && start.x < -90.0;
                bool toku2 = 80.0 < start.y && start.y < 207.0;
                bool toku3 = -249.0 < end.x && end.x < -90.0;
                bool toku4 = -63.0 < end.y && end.y < 80.0;
                bool toku5 = sumDistance < 280.0;

                sumDistance = 0.0;

                if (toku1 & toku2 & toku3 & toku4 & toku5) //条件と比較
                {
