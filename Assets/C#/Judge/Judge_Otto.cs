...
{
    public class Judge_Otto : MonoBehaviour
    {
        ...
        string judgingOtto(){
                ...
                bool shitsu1 = -112.0 < start.x && start.x < 21.0;
                bool shitsu2 = 61.0 < start.y && start.y < 231.0;
                bool shitsu3 = -173.0 < end.x && end.x < -19.0;
                bool shitsu4 = -19.0 < end.y && end.y < 133.0;
                bool shitsu5 = sumDistance < 320.0;

                bool mi1 = -79.0 < start.x && start.x < 81.0;
                bool mi2 = -49.0 < start.y && start.y < 201.0;
                bool mi3 = -79.0 < end.x && end.x < 81.0;
                bool mi4 = -259.0 < end.y && end.y < 121.0;
                bool mi5 = sumDistance < 760.0;

                sumDistance = 0.0;

               if (shitsu1 & shitsu2 & shitsu3 & shitsu4 & shitsu5) //条件と比較
                {
                    DataManager.Instance.isCorrect = 1;
                    DataManager.Instance.isdivide = 1;
                    DataManager.Instance.isScene = 1;
                    return "失";
                } else if (mi1 & mi2 & mi3 & mi4 & mi5)
                {
