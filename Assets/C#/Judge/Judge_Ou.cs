...
{
    public class Judge_Ou : MonoBehaviour
    {
        ...
        string judgingOu(){
                ...
                bool tama1 = 1.0 < start.x && start.x < 130.0;
                bool tama2 = -120.0 < start.y && start.y < 0.0;
                bool tama3 = 1.0 < end.x && end.x < 130.0;
                bool tama4 = -120.0 < end.y && end.y < 0.0;
                bool tama5 = sumDistance < 130.0;

                bool nushi1 = -59.0 < start.x && start.x < 41.0;
                bool nushi2 = 109.0 < start.y && start.y < 231.0;
                bool nushi3 = -59.0 < end.x && end.x < 61.0;
                bool nushi4 = 109.0 < end.y && end.y < 231.0;
                bool nushi5 = sumDistance < 110.0;

                bool go1 = 41.0 < start.x && start.x < 110.0;
                bool go2 = -20.0 < start.y && start.y < 51.0;
                bool go3 = 41.0 < end.x && end.x < 110.0;
                bool go4 = -115.0 < end.y && end.y < -39.0;
                bool go5 = sumDistance < 250.0; 

                sumDistance = 0.0;

                if (tama1 & tama2 & tama3 & tama4 & tama5) //条件と比較
                {
                 ...
                 else if (nushi1 & nushi2 & nushi3 & nushi4 & nushi5)
                {
