...
{
    public class Judge_Ryo : MonoBehaviour
    {
        ...
        string judgingRyo(){
                ...
                bool ko1 = -250.0 < start.x && start.x < -29.0;
                bool ko2 = -90.0 < start.y && start.y < 40.0;
                bool ko3 = 20.0 < end.x && end.x < 250.0;
                bool ko4 = -70.0 < end.y && end.y < 40.0;
                bool ko5 = sumDistance < 400.0;
