...
{
    public class Judge_Sara : MonoBehaviour
    {
        ...
        string judgingSara(){
                ...
                bool chi1 = -85.0 < start.x && start.x < 60.0;
                bool chi2 = 90.0 < start.y && start.y < 250.0;
                bool chi3 = -140.0 < end.x && end.x < 0.0;
                bool chi4 = 30.0 < end.y && end.y < 150.0;
                bool chi5 = sumDistance < 220.0;

                sumDistance = 0.0;

                if (chi1 & chi2 & chi3 & chi4 & chi5) //条件と比較
                {
