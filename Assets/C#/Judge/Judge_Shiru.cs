...
{
    public class Judge_Shiru : MonoBehaviour
    {
        ...
        string judgingShiru(){
                ...
                bool ase1 = -50.0 < start.x && start.x < 30.0;
                bool ase2 = 111.0 < start.y && start.y < 190.0;
                bool ase3 = 71.0 < end.x && end.x < 200.0;
                bool ase4 = 111.0 < end.y && end.y < 190.0;
                bool ase5 = sumDistance < 245.0;
                
                sumDistance = 0.0;

                if (ase1 & ase2 & ase3 & ase4 & ase5) //条件と比較
                {
