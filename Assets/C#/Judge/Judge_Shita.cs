...
{
    public class Judge_Shita : MonoBehaviour
    {
        ...
        string judgingShita(){
                ...
                bool hu1 = -110.0 < start.x && start.x < 31.0;
                bool hu2 = -20.0 < start.y && start.y < 141.0;
                bool hu3 = -170.0 < end.x && end.x < -39.0;
                bool hu4 = -110.0 < end.y && end.y < 61.0;
                bool hu5 = sumDistance < 300.0;
                
                sumDistance = 0.0;

                if (hu1 & hu2 & hu3 & hu4 & hu5) //条件と比較
                {
