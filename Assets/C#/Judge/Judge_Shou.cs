...
{
    public class Judge_Shou : MonoBehaviour
    {
        ...
        string judgingShou(){
                ...
                bool shou1 = -59.0 < start.x && start.x < 175.0;
                bool shou2 = -195.0 < start.y && start.y < 0.0;
                bool shou3 = -209.0 < end.x && end.x < 0.0;
                bool shou4 = -375.0 < end.y && end.y < -119.0;
                bool shou5 = sumDistance < 450.0;
                
                sumDistance = 0.0;

                if (shou1 & shou2 & shou3 & shou4 & shou5) //条件と比較
                {
