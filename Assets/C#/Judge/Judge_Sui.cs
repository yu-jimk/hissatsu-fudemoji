...
{
    public class Judge_Sui : MonoBehaviour
    {
        ...
        string judgingOto(){
                ...
                bool shi1 = -41.0 < start.x && start.x < 31.0;
                bool shi2 = 115.0 < start.y && start.y < 210.0;
                bool shi3 = 80.0 < end.x && end.x < 200.0;
                bool shi4 = 115.0 < end.y && end.y < 210.0;
                bool shi5 = sumDistance < 500.0;
                
                sumDistance = 0.0;

                if (shi1 & shi2 & shi3 & shi4 & shi5) //条件と比較
                {
