...
{
    public class Judge_Sumu : MonoBehaviour
    {
        ...
        string judgingSumu(){
                ...
                bool ou1 = -200.0 < start.x && start.x < -55.0;
                bool ou2 = 25.0 < start.y && start.y < 191.0;
                bool ou3 = -230.0 < end.x && end.x < -119.0;
                bool ou4 = -15.0 < end.y && end.y < 100.0;
