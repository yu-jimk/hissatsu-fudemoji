...
{
    public class Judge_T : MonoBehaviour
    {
        ...
        string judgingUshinau()
        {
            ...
            bool shita1 = -20.0 < start.x && start.x < 70.0;
            bool shita2 = 60.0 < start.y && start.y < 120.0;
            bool shita3 = 20.0 < end.x && end.x < 180.0;
            bool shita4 = -30.0 < end.y && end.y < 100.0;
            bool shita5 = sumDistance < 400.0;

            bool kan1 = -250.0 < start.x && start.x < -120.0;
            bool kan2 = -60.0 < start.y && start.y < 170.0;
            bool kan3 =  120.0 < end.x && end.x < 250.0;
            bool kan4 = -60.0 < end.y && end.y < 170.0;
            bool kan5 = sumDistance < 350.0;

            sumDistance = 0.0;

            if (shita1 & shita2 & shita3 & shita4 & shita5) //条件と比較
            {
            ...
            else if (kan1 & kan2 & kan3 & kan4 & kan5) //条件と比較
            {
