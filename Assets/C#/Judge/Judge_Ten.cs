...
{
    public class Judge_Ten : MonoBehaviour
    {
        ...
        string judgingTen(){
                ...
                bool sue1 = -39.0 < start.x && start.x < 21.0;
                bool sue2 = 131.0 < start.y && start.y < 211.0;
                bool sue3 = -39.0 < end.x && end.x < 21.0;
                bool sue4 = -169.0 < end.y && end.y < -99.0;
                bool sue5 = sumDistance < 400.0;
                
                sumDistance = 0.0;

                if (sue1 & sue2 & sue3 & sue4 & sue5) //条件と比較
                {
