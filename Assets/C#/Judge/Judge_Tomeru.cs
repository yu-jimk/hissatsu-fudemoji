...
{
    public class Judge_Tomeru : MonoBehaviour
    {
        ...
        string judgingTomeru(){
                ...
                bool sei1 = -300 < start.x && start.x < 0;
                bool sei2 = 0 < start.y && start.y < 300;
                bool sei3 = 0 < end.x && end.x < 300;
                bool sei4 = 0 < end.y && end.y < 300;
                bool sei5 = sumDistance < 10000;
                
                sumDistance = 0.0;

                if (sei1 & sei2 & sei3 & sei4 & sei5) //条件と比較
                {
