...
{
    public class Judge_Tsuchi : MonoBehaviour
    {
        ...
        string judgingTsuchi(){
                ...
                bool ou1 = -179.0 < start.x && start.x < -60.0;
                bool ou2 = 77.0 < start.y && start.y < 205.0;
                bool ou3 = 41.0 < end.x && end.x < 161.0;
                bool ou4 = 77.0 < end.y && end.y < 205.0;
                bool ou5 = sumDistance < 300.0;

                bool shi1 = -205.0 < start.x && start.x < -119.0;
                bool shi2 = -70.0 < start.y && start.y < 70.0;
                bool shi3 = 101.0 < end.x && end.x < 205.0;
                bool shi4 = -50.0 < end.y && end.y < 50.0;
