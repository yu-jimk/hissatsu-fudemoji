...
{
    public class Judge_Tsukaeru : MonoBehaviour
    {
        ...
        string judgingTsukaeru(){
                ...
                bool nin1 = 55.0 < start.x && start.x < 200.0;
                bool nin2 = 111.0 < start.y && start.y < 221.0;
                bool nin3 = -90.0 < end.x && end.x < 31.0;
                bool nin4 = 41.0 < end.y && end.y < 180.0;
                bool nin5 = sumDistance < 400.0;
               
                sumDistance = 0.0;

                if (nin1 & nin2 & nin3 & nin4 & nin5) //条件と比較
                {
