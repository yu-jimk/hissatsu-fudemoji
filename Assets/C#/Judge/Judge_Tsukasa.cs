...
{
    public class Judge_Tsukasa : MonoBehaviour
    {
        ...
        string judgingTsukasa(){
                ...
                bool dou1 = -190.0 < start.x && start.x < -79.0;
                bool dou2 = 75.0 < start.y && start.y < 150.0;
                bool dou3 = -190.0 < end.x && end.x < -79.0;
                bool dou4 = -220.0 < end.y && end.y < -45.0;
                bool dou5 = sumDistance < 600.0;
                
                sumDistance = 0.0;

                if (dou1 & dou2 & dou3 & dou4 & dou5) //条件と比較
                {
