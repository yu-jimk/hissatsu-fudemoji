...
{
    public class Judge_Uchi : MonoBehaviour
    {
        ...
        string judgingUchi(){
                ...
                bool hei1 = -221.0 < start.x && start.x < -9.0;
                bool hei2 = 110.0 < start.y && start.y < 215.0;
                bool hei3 = -9.0 < end.x && end.x < 191.0;
                bool hei4 = 110.0 < end.y && end.y < 215.0;
                bool hei5 = sumDistance < 350.0;


                sumDistance = 0.0;

                if (hei1 & hei2 & hei3 & hei4 & hei5) //条件と比較
                {
