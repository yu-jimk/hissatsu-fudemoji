...
{
    public class Judge_Uranau : MonoBehaviour
    {
        ...
        string judgingUranau(){
                ...
                bool ko1 = -199.0 < start.x && start.x < 199.0;
                bool ko2 = -3.0 < start.y && start.y < 147.0;
                bool ko3 = -65.0 < end.x && end.x < 191.0;
                bool ko4 = 5.0 < end.y && end.y < 147.0;
                bool ko5 = sumDistance < 640.0;

                sumDistance = 0.0;

                if (ko1 & ko2 & ko3 & ko4 & ko5) //条件と比較
                {
