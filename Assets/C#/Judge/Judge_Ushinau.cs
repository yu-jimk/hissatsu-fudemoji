...
{
    public class Judge_Ushinau : MonoBehaviour
    {
        ...
        string judgingUshinau(){
                ...
                bool shu1 = -45.0 < start.x && start.x < 45.0;
                bool shu2 = -63.0 < start.y && start.y < 200.0;
                bool shu3 = -45.0 < end.x && end.x < 45.0;
                bool shu4 = -219.0 < end.y && end.y < -19.0;
                bool shu5 = sumDistance < 800.0;
