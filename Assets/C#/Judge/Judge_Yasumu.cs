...
{
    public class Judge_Yasumu : MonoBehaviour
    {
        ...
        string judgingYasumu(){
                ...
                bool karada1 = -109.0 < start.x && start.x < 45.0;
                bool karada2 = -130.0 < start.y && start.y < 20.0;
                bool karada3 = -5.0 < end.x && end.x < 175.0;
                bool karada4 = -130.0 < end.y && end.y < 20.0;
                bool karada5 = sumDistance < 300.0;


                sumDistance = 0.0;

                if (karada1 & karada2 & karada3 & karada4 & karada5) //条件と比較
                {
