...
{
    public class Judge_Yo : MonoBehaviour
    {
        ...
        string judgingYo(){
                ...
                bool hoko1 = -89.0 < start.x && start.x < 91.0;
                bool hoko2 = -33.0 < start.y && start.y < 131.0;
                bool hoko3 = -189.0 < end.x && end.x < 11.0;
                bool hoko4 = -129.0 < end.y && end.y < 71.0;
                bool hoko5 = sumDistance < 600.0;



                sumDistance = 0.0;

                if (hoko1 & hoko2 & hoko3 & hoko4 & hoko5) //条件と比較
                {
