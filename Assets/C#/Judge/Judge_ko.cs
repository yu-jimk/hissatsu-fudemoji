...
{
    public class Judge_ko : MonoBehaviour
    {
        ...
        string judgingUshinau()
        {
            ...
            bool yama1 = -120.0 < start.x && start.x < 120.0;
            bool yama2 = 110.0 < start.y && start.y < 250.0;
            bool yama3 = -120.0 < end.x && end.x < 120.0;
            bool yama4 = -100.0 < end.y && end.y < -50.0;
            bool yama5 = sumDistance < 500.0;

            bool kuchi1 = -180.0 < start.x && start.x < 180.0;
            bool kuchi2 = 20.0 < start.y && start.y < 170.0;
            bool kuchi3 = -180.0 < end.x && end.x < 180.0;
            bool kuchi4 = 20.0 < end.y && end.y < 170.0;
            bool kuchi5 = sumDistance < 500.0;

            sumDistance = 0.0;

            if (yama1 & yama2 & yama3 & yama4 & yama5) //条件と比較
            {
            ...
            else if (kuchi1 & kuchi2 & kuchi3 & kuchi4 & kuchi5) //条件と比較
            {
